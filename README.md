...
# 网格采样成点云
python scripts/process_data/mesh_sampler.py

# 生成凸包
 python convex_hull.py --i tooth_pc1.ply --face 20000 --o tooth_initmesh.obj  --manifold-path /zxx/code/point2mesh-master/code/Manifold/build/
