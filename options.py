...
MANIFOLD_DIR = r'/zxx/code/point2mesh-master/code/Manifold/build/'  # path to manifold software (https://github.com/hjwdzh/Manifold)
...
class Options:
    ...
    def parse_args(self):
        ...
        parser.add_argument('--save-path', type=str, default='./checkpoints/tooth', help='path to save results to')
        parser.add_argument('--input-pc', type=str, default='./data/tooth.ply', help='input point cloud')
        parser.add_argument('--initial-mesh', type=str, default='./data/tiki_initmesh.obj', help='initial mesh')
        ...
        # 加载模型
        parser.add_argument('--load-model', type=int, default=0, help='load-model')
